    ...
    <div>
      <div :style="item.nodeStyle"
        ...
        <i
          ...
          :style="item.iconStyle" :class="`${item.iconClassName || 'el-icon-coin'} icon icon-data`"/>
        <input
