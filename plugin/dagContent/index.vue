<template>
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="100%"
    height="1029" data-spm-anchor-id="TODO.11007039.0.i6.12b64a9bcbXQmm"
    ...
    <g :transform="` translate(${svg_left}, ${svg_top}) scale(${svgScale})`">
      ...
      <SimulateSelArea v-if="['sel_area', 'sel_area_ing'].indexOf(currentEvent) !== -1"
    ...
    methods: {
      ...
      changeModelRunningStatus(status) {
        ...
        if (status) {
          ...
          this.$emit('updateDAG', this.DataAll, 'pauseRunning')
        }
      },
      /**
       * 执行debug操作
